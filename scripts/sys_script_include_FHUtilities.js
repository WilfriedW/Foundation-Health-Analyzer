/**
 * FHUtilities - Utility functions for Foundation Health Analyzer
 * Contains useful functions recovered from deprecated script includes
 * 
 * @version 1.0.0
 * @created 2026-01-17
 */
var FHUtilities = Class.create();
FHUtilities.prototype = {
